...
const Teams = () => {
    return (
        ...
        whileInView="visible"
        viewport={{once:true}}
         className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-28 text-gray-800 dark:text-white'>
            <Title
                title='Meet the team'
                desc="A passionate team of digital experts is dedicated to your brand's success."
            />
